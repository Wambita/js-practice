...
const  cutFirst = (string) => (string.length >= 2 ) ? '': string.substring(2, string.length)
...
function keepFirstLast(string) {
    if (string.length <= 4) return string  // if string length is less than 2, return an empty string.
